...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--printer-mode", choices=("preview", "file", "command", "escpos-network", "epson-epos"))
    ...
    parser.add_argument("--epson-epos-host")
    parser.add_argument("--epson-epos-url", help=argparse.SUPPRESS)
...
def merge_config(base: AppConfig, args: argparse.Namespace) -> AppConfig:
    config = AppConfig(
        ...
        epson_epos_host=args.epson_epos_host or base.epson_epos_host,
        epson_epos_url=args.epson_epos_url or base.epson_epos_url,
    )
    return config
